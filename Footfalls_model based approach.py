...
df = pd.read_csv(r"C:\Users\Forecasting\Forecasting\Walmart Footfalls Raw.csv")
...
predict_data = pd.read_excel(r"C:\Users\Forecasting\Forecasting\Predict_new.xlsx")
